    ...
    # Accéder au dictionnaire des génomes
        ...
        # Ne conserver que le dernier génome trouvé pour l'espèce
            ...
            genome_browser = {"gene_symbol": gene, "genome": last_genome, "species": species_name, 
                                "lien_ucsc":f'<a href="https://genome.ucsc.edu/cgi-bin/hgTracks?db={last_genome}&position={gene}" target="_blank">View {gene} in UCSC genome browser</a>' }
        else:
            genome_browser = {"gene_symbol": gene, "genome": "Aucun genome trouvé", "species": species_name,"lien_ucsc": "Not in UCSC"}
